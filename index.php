      ...
      *** TOPBAR ***
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="index.php" class="navbar-brand home"><img src="rent_2.png" alt="RHMS logo" class="d-none d-md-inline-block"></a>
          <div class="col-lg-6 offer mb-3 mb-lg-0"><a href="index.php" class="ml-1"><b><b><b><b><b><b>KAA CHONJO MANAGEMENT SYSTEM</b></b></b></b></b></b></a></div>
            ...
            <div class="product-slider owl-carousel owl-theme">
              ...
              <div class="item">
                <div class="product">
                  ...
                  <div class="text">
                    <h3><a href="login.php">Ksh. 50,000/=</a></h3>
                    <p class="price">
              ...
              <div class="item">
                <div class="product">
                  ...
                  <div class="text">
                    <h3><a href="login.php">Ksh. 60,000/=</a></h3>
                    <p class="price">
                      Available Rooms:<br/><?php
              ...
              <div class="item">
                <div class="product">
                  ...
                  <div class="text">
                    <h3><a href="login.php">Ksh. 70,000/=</a></h3>
                    <p class="price">
                      Available Rooms:<br/><?php
              ...
              <div class="item">
                <div class="product">
                  ...
                  <div class="text">
                    <h3><a href="login.php">Ksh. 80,000/=</a></h3>
                    <p class="price">
                      Available Rooms:<br/><?php
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-2 mb-lg-0">
            <p class="text-center text-lg-left">Copyright &copy; GIDDY 2023</p>
          </div>
        </div>
      </div>
    </div>
